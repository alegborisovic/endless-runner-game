...
# game song
pygame.mixer.music.load("images/song/gamesong.mp3")
...
sky = pygame.image.load('images/bg/parallax-forest-back-trees.png').convert_alpha()
num_bg_tiles = math.ceil(game_width / sky.get_width()) + 1

# set the images for the parallax background
bgs = []
bgs.append(pygame.image.load('images/bg/parallax-forest-lights.png').convert_alpha())
bgs.append(pygame.image.load('images/bg/parallax-forest-middle-trees.png').convert_alpha())
bgs.append(pygame.image.load('images/bg/parallax-forest-front-trees.png').convert_alpha())
